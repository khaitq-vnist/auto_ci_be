...
type IRepositoryService interface {
	GetRepositoriesByIntegrationId(c context.Context, inId, userId int64) ([]*dto.ThirdPartyProviderReposResponse, error)
}
type RepositoryService struct {
	getRepositoryUseCase usecase.IGetRepositoryUseCase
}

func (r RepositoryService) GetRepositoriesByIntegrationId(c context.Context, itId, userId int64) ([]*dto.ThirdPartyProviderReposResponse, error) {
